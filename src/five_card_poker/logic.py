...
from .models import Card, Suit, Rank, Hand
...
class GameLogic:
    def __init__(self):
        ...
        self.phase = "betting"  # betting, drawing
    ...
    def draw(self, held_indices: list[int]) -> Hand:
        ...
        payout = self.calculate_payout(rank_name, self.current_bet)
        self.balance += payout
        self.phase = "betting"
        return self.current_hand

    def calculate_payout(self, rank_name: str, bet: int) -> int:
        payout_multipliers = {
            "Royal Flush": 800,
            "Straight Flush": 50,
            "Four of a Kind": 25,
        ...
        multiplier = payout_multipliers.get(rank_name, 0)
